...
import (
	...
	aihaov1beta1 "crddemo/pkg/apis/aihao/v1beta1"
...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this aihao.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &aihaov1beta1.Application{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &aihaov1beta1.Application{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=aihao.k8s.io,resources=applications,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileApplication) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Application instance
	instance := &aihaov1beta1.Application{}
